...
VaultsModel::Private::Private(VaultsModel *parent)
    : service(QStringLiteral("org.kde.kded6"), QStringLiteral("/modules/plasmavault"), QDBusConnection::sessionBus())
    , serviceWatcher(QStringLiteral("org.kde.kded6"), QDBusConnection::sessionBus())
    , q(parent)
{
    ...
    connect(&serviceWatcher, &QDBusServiceWatcher::serviceOwnerChanged, this, [this](const QString &service, const QString &oldOwner, const QString &newOwner) {
        ...
        if (service != QLatin1String("org.kde.kded6")) {
            return;
        }
